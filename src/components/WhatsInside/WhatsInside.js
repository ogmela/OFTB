    ...
    const pageArray = [
        {
            ...
            img: JournalPage,
            title: "Journal Pages",
            text: "Write down the stories you'll be telling for years to come, like those iconic memories that start with 'Remember when...?', the moments that you can't think about without bursting into laughs, or the tender memories that you'll carry forever in your heart (and this book!).",
        },
        {
            className: WhatsInsideStyles.onePage,
            img: FriendPage,
            title: "Friend Profiles",
            text: "Because every great story has great characters-dedicate a page to the friends who made the moments so special.",
        },
        {
            className: WhatsInsideStyles.onePage,
            img: PhotoPage,
            title: "Little Moments, Big Memories",
            text: "This is the perfect spot for those quick, unforgettable moments! Jot down your mini memories, add a photo and let the story shine.",
        },
        {
            className: WhatsInsideStyles.onePage,
            img: IndexPage,
            title: "Index Pages",
            text: "A custom table of contents for your stories. Add page numbers and titles as you go so you can flip right to the good stuff later.",
        }
    ]
